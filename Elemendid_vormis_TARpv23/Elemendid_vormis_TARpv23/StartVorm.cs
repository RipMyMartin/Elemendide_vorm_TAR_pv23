...
namespace Elemendid_vormis_TARpv23
{
    public partial class StartVorm : Form
    {
        ...
        public StartVorm()
        {
            ...
            pbox.Image = Image.FromFile(@"..\..\..\teine.png");
        ...
        private void Tree_AfterSelect(object? sender, TreeViewEventArgs e)
        {
            ...
            else if (e.Node.Text == "Märkeruut")
            {
                ...
                chk2.BackgroundImage = Image.FromFile(@"..\..\..\teine.png");
            ...
            else if (e.Node.Text == "Vormid")
            {
                ...
                btnEsimene.Click += Click_EsimeneVorm;
                ...
                btnTeine.Click += Click_TeineVorm;
                Controls.Add(btnTeine);

                x += buttonWidth + buttonSpacing;

                Button btnKolmas = new Button { Text = "Kolmas Vorm", Size = new Size(buttonWidth, 20), Location = new Point(x, y) };
                btnKolmas.Click += Click_KolmnasVorm;
                Controls.Add(btnKolmas);
            }
        }

        private void Click_EsimeneVorm(object? sender, EventArgs e)
        {
            EsimeneVorm esimeneVorm = new EsimeneVorm(500, 700);
            esimeneVorm.Show();
        }
        private void Click_TeineVorm(object? sender, EventArgs e)
        {
